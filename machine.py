...
class Machine:
    def __init__(self):
        ...
        # import sounds
        self.spin_sound = pygame.mixer.Sound('PySlots Michael Miklus II CIS 189 16025/audio/pyslots_reel.mp3')
        self.spin_sound.set_volume(0.15)
        self.win_three = pygame.mixer.Sound('PySlots Michael Miklus II CIS 189 16025/audio/pyslots_winthree.mp3')
        self.win_three.set_volume(0.6)
        self.win_four = pygame.mixer.Sound('PySlots Michael Miklus II CIS 189 16025/audio/pyslots_winfour.mp3')
        self.win_four.set_volume(0.7)
        self.win_five = pygame.mixer.Sound('PySlots Michael Miklus II CIS 189 16025/audio/pyslots_winfive.mp3')
