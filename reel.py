...
class Reel:
    def __init__(self, pos):
        ...
        # sounds
        self.stop_sound = pygame.mixer.Sound('PySlots Michael Miklus II CIS 189 16025/audio/pyslots_spin.mp3')
    ...
    def animate(self, delta_time):
        ...
        if self.reel_is_spinning:
            ...
            if self.delay_time <= 0:
                ...
                # iterate through all 5 symbols in reels
    ...
    def reel_spin_result(self):
        # get and return text representation
        spin_symbols = []
        for i in game_indicies:
...
class Symbol(pygame.sprite.Sprite):
    def __init__(self, pathToFile, pos, idx):
        ...
        self.rect = self.image.rect_rect(topleft = pos)
